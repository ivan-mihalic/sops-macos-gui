...
struct ProjectFindingIdentityTests {
    ...
    /// only six distinct ids. Now twelve: ticket #3 added a fourth finding
    /// per project (`rotation-debt`), which does not change what this test
    /// is about — id uniqueness — only the count.
